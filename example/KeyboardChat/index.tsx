...
import { Animated, findNodeHandle, Image, Pressable, ScrollView, Text, TextInput, View } from 'react-native'
...
function KeyboardChat() {
  ...
  return (
    <SafeAreaProvider style={styles.provider}>
      <KeyboardInsetsView onKeyboard={keyboard.createCallback(driverState)} style={[styles.fill, mainStyle]}>
      ...
      <Animated.View style={[styles.absolute, styles.red, emoji.style]} onLayout={emoji.onLayout} ref={emojiRef}>
        <View style={styles.emoji}>
          <Text style={styles.text}>表情包</Text>
        </View>
        <SafeAreaView edges={['bottom']} />
      </Animated.View>
      <Animated.View style={[styles.absolute, styles.blue, toolbox.style]} onLayout={toolbox.onLayout} ref={toolboxRef}>
